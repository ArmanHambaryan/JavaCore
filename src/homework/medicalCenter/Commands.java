...
public interface Commands {
    ...
    static void printCommands() {
        ...
        System.out.println("Plase input " + ADD_PATIENT + " for ADD PATIENT ");
        System.out.println("Plase input " + PRINT_ALL_PATIENTS_BY_DOCTOR + " for PRINT ALL PATIENTS BY DOCTOR ");
        System.out.println("Plase input " + PRINT_ALL_PATIENTS + " PRINT ALL PATIENTS ");
