...
public interface Commands {
    ...
    String SEARCH_BOOK_FOR_PRICE_RANGE = "6";
    ...
    static void printCommands() {
        ...
        System.out.println("Plase input " + DELETE_BY_ID + " for DELETE BOOK BY ID");
        System.out.println("Plase input " + SEARCH_BOOK_FOR_PRICE_RANGE + " for SEARCH BOOK BY PRICE RANGE ");
